...
function toggleMenu() {
    ...
    if (navLinks && hamburger) {
        ...
        console.log("Toggled active class:", navLinks.classList.contains('active')); // Debug log
        console.log("Nav-links computed styles:", {
            ...
            transform: window.getComputedStyle(navLinks).transform
        }); // Detailed debug
        // Temporary visibility check for debugging
        if (!navLinks.classList.contains('active')) {
            navLinks.style.display = 'none'; // Ensure it hides when inactive
        } else {
            navLinks.style.display = 'flex'; // Force display for testing
            console.log("Forced display: flex for debugging");
        }
    } else {
        console.error("nav-links or hamburger not found"); // Debug error
    }
}
...
function showPage(pageId) {
    ...
    if (navLinks && hamburger) {
        ...
        console.log("Hamburger menu closed after page change"); // Debug log
    }
